const config = {
  ...
  rssFeeds:
    ...
    [
      // Fact-checkers (high signal)
      "https://www.snopes.com/feed/",
      "https://www.politifact.com/rss/all/",
      "https://factcheck.afp.com/feed",
      ...
      "https://www.wired.com/feed/tag/deepfakes/rss",
      ...
      "https://www.vice.com/en/topic/deepfakes/rss",
  ...
  rssFeedsPerRun: Number(process.env.RSS_FEEDS_PER_RUN || 24),
