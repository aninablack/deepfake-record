...
const config = {
  ...
  gdeltQuery:
    ...
    '(deepfake OR "synthetic media" OR "AI-generated" OR "voice clone") sourcelang:English',
  ...
  rssFeeds:
    ...
    [
      ...
      'https://www.independent.co.uk/topic/artificial-intelligence/rss',
      ...
      'https://cyber.fsi.stanford.edu/io/feed',
      'https://aiincidents.com/feed',
      'https://www.partnershiponai.org/feed/',
      'https://firstdraftnews.org/feed',
    ].join(','),

  rssMaxItemsPerFeed: Number(process.env.RSS_MAX_ITEMS_PER_FEED || 10),
  rssFeedsPerRun: Number(process.env.RSS_FEEDS_PER_RUN || 12),
  ...
  maxArticleAgeDays: Number(process.env.MAX_ARTICLE_AGE_DAYS || 30),
